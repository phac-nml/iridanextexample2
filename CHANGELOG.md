...
- Adding an iridanext parameter that controls Irida Next behaviour, including renaming output files.
...
- Added output of version for `MERGE_METADATA` module. [PR #13](https://github.com/phac-nml/iridanextexample2/pull/13)
